...
// Then we're adding a controller.
  introApp.controller( 'FirstCtrl', ['$scope', '$log', function ( $scope, $log ) {
    $log.log( 'Called FirstCtrl' );
...
// Controller for add-name.html
  introApp.controller( 'AddNameCtrl', ['$scope', '$log', function ( $scope, $log ) {
...
// Controller for highlight-match.html
  introApp.controller( 'HighlightCtrl', ['$scope', '$log', function ( $scope, $log ) {
    $scope.names = ['John', 'Dan', 'Tim', 'Andre', 'Angela',
      'Maria', 'Andres', 'Chuck', 'Joseph', 'Jose'];
