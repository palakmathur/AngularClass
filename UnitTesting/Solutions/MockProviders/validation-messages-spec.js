describe( 'validation-messages.js', function () {
  ...
  beforeEach( function () {
    ...
    module( function ( $provide ) {
      $provide.factory( 'customerDAO', function () {
        return {
    ...
    describe( 'Data refreshes', function () {
      ...
      it( 'should call customerDAO.refresh() on a change to $scope.dbobj.contactName',
        function () {
           ...
           */
          testScope.dbobj.contactName = 'Bob Roberts';
          testScope.$digest();

          expect( refreshSpy.calls.count() ).toBe( 1 );
          expect( refreshSpy.calls.argsFor( 0 )[0] ).toEqual( testScope.dbobj );
